  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => AttendanceBloc(AttendanceUseCase(AttendanceRepositoryImpl(AttendanceRemoteDataSource())),
        ),
        ),
        BlocProvider(create: (context) => TotpBloc(getTotpUseCase: GetTotpUseCase(repository: TotpRepositoryImpl(remoteDataSource: TotpRemoteDataSourceImpl(dioClient: dioClient))))),
      ],
      child: MaterialApp(
